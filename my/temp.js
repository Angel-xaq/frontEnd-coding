...
// // /* 输出
// // *   林一一 函数 setTimeout，obj.callback(这只是一个引用地址) 中并没有直接调用者，可以理解为是setTimeout中的回调函数，this 就指向 window。所以输出的 name 就是全局下的 林一一。
// // */
...
// /* 输出
// *   '二二'  很明显箭头函数的 this 来自函数 fn，对象 obj 调用了函数 fn，所以 fn 的 this 指向 obj，输出结果就是 二二。
// */
